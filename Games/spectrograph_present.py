...
Presentation:
Section 0 - opens window
Section 1 - starts data streams
- trace through update eeg, update data, graph data getting
- data saving
next, graph modes, incl spectrogram
Finally, showfile reading and stepping
...
class spectrograph_gui(QWidget):
    ...
    def start_data_stream(self):
        ...
        # this starts the processes for data streaming
...
if __name__ == "__main__":
    ...
    ui = spectrograph_gui(hardware = 'Muse', model = 'Muse S', data_type = 'Simulate', parent = Form) 
